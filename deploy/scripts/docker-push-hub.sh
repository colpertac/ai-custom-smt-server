...
#
# Usage:
#   ./deploy/scripts/docker-pack-runtime.sh              # build smt-comp:local only
#   ./deploy/scripts/docker-push-hub.sh                  # pack + tag + push colpertac/smt-comp
#   DOCKER_HUB_USER=me IMAGE_NAME=smt-comp ./deploy/scripts/docker-push-hub.sh
