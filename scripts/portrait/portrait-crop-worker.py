...
Examples:
  python3 scripts/portrait/portrait-crop-worker.py crop ~/repos/smt/va_screenshots/Screenshot_….png
  python3 scripts/portrait/portrait-crop-worker.py watch
  python3 scripts/portrait/portrait-crop-worker.py watch --inbox /home/cat/repos/smt/va_screenshots
